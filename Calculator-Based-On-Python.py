...
class app(Frame):
        def __init__(self):
                ...
                Entry(self, relief=FLAT,
                      textvariable=display, justify='right', bd=12, bg='powder blue').pack(side=TOP, expand=YES, fill=BOTH)
